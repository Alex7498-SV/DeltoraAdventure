 ...
 */
public class VentanaPeleaEspartanoBoss extends JFrame {
    
    public JLabel mago, enemigo, atacar,vidaEnemigo;
    
    public int restarVida = 40;
    
    public VentanaPeleaEspartanoBoss(){
    ...
    public void VentanaDePelea(){
        ...
        enemigo.setIcon(new ImageIcon(getClass().getResource("/imagenesEspartano/BossNathanF.png")));
